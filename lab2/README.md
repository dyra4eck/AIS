...
|---|---:|---|
| [`cpu_pkg.vhd`](rtl/cpu_pkg.vhd) | 157 | константы, коды операций, записи конвейерных регистров, АЛУ |
| [`cpu_core.vhd`](rtl/cpu_core.vhd) | 418 | ядро: PC, регистр флагов, 16 РОН, 3 конвейера × 4 ступени, блок разрешения конфликта, счётчики, монитор, трасса |
...
| [`cpu_system.vhd`](rtl/cpu_system.vhd) | 64 | верхний уровень |
